...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color:rgba(255, 47, 175, 0.295); ">
...
<html lang="en">
  ...
  <body>    
        <div class="jumbotron jumbotron-fluid" style="background-color:rgba(212, 0, 255, 0.377);">        
            <div class="container text-center">
...
## RESULT:
Thus, the websites: http://loghul.student.saveetha.in:8000/HouseModelTraining/ and http://loghul.student.saveetha.in:8000/HouseModelPrediction/ successfully displays the house price pridiction and house model training.